...
public class RabbitPropertiesTest {
    ...
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            ...
            .withPropertyValues(
                    "app.rabbit.googleMeetQueue=%s".formatted(GOOGLE_MEET_QUEUE),
                    ...
                    "app.rabbit.googleMeetRoutingKey=%s".formatted(GOOGLE_MEET_ROUTING_KEY),
    ...
    void testRabbitPropertiesBinding() {
        contextRunner.run(context -> {
            ...
            assertThat(props.googleMeetQueue()).isEqualTo(GOOGLE_MEET_QUEUE);
            ...
            assertThat(props.googleMeetRoutingKey()).isEqualTo(GOOGLE_MEET_ROUTING_KEY);
